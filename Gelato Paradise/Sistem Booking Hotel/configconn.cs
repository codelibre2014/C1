...
namespace Sistem_Booking_Hotel
{
    ...
    public class configconn
    {
        ...
        //public SqlConnection KoneksiDB()
        //{
        //    conn = new SqlConnection("Data Source=tcp:192.168.10.3\\SQLEXPRESS,49172;Initial Catalog=hoteldb;UID=dell;PWD=dell;");
        //    conn.Open();
        //    return conn;
        //}
        ...
        //public SqlConnection KoneksiDB()
        //{
        //    conn = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=workstation_dev;Integrated Security=True;User ID=NT Service\\MSSQL$SQLEXPRESS;Connection Timeout=60;Connection Lifetime=0;Min Pool Size=0;Max Pool Size=100;Pooling=true;");
        //    conn.Open();
        //    return conn;
        //}
        ...
        //public SqlConnection KoneksiDB()
        //{
        //    conn = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=workstation;Integrated Security=True;User ID=NT Service\\MSSQL$SQLEXPRESS;Connection Timeout=60;Connection Lifetime=0;Min Pool Size=0;Max Pool Size=100;Pooling=true;");
        //    conn.Open();
        //    return conn;
        //}
